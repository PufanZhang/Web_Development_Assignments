...
const endingContext = [
    ...
    "\n"+
    "        火光中，你找到了答案。\n" +
    "        背叛从来都不是突如其来的——它藏在队长冷静的眼睛里，藏在每一个被否决的撤离建议里，藏在突然失灵的探测器中。\n"+
    "        你选择了怀疑，选择了站出来。那一刻，你不是英雄，你只是一个不愿再被谎言带走任何同伴的人。\n" +
    "        护盾瓦解，炮火照亮天际。内奸的嘶吼很快被爆炸声吞没。你们赢了这一仗，用信任换回了生机。\n" +
    "        可当硝烟散去， 沉默再次降临。你站在那里，胜利是真的，迷茫也是真的。\n"+
    "        有些真相才刚刚露出了一角，而阴谋并没有终结，它只是换一副面具，继续追问。"
];
